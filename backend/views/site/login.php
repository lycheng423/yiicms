...
<?= Html::cssFile('/static/css/font-awesome.min.css'); ?>
<?= Html::cssFile('/static/css/animate.min.css'); ?>
<?= Html::cssFile('/static/css/style.min.css'); ?>
<?= Html::cssFile('/static/css/login.min.css'); ?>
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="signin-info">
                ...
                <ul class="m-b">
                    <li><i class="fa fa-arrow-circle-o-right m-r-xs"></i> 基于Yii2框架开发的开源系统</li>
                    <li><i class="fa fa-arrow-circle-o-right m-r-xs"></i> 集成用户权限管理系统</li>
                </ul>
            </div>
        </div>
        <div class="col-sm-5">
