...
<head>
    ...
    <![endif]-->
    <?= Html::cssFile('/static/css/bootstrap.min.css?v=3.3.5'); ?>
    <?= Html::cssFile('/static/css/font-awesome.min.css?v=4.4.0'); ?>
    <?= Html::cssFile('/static/css/animate.min.css'); ?>
    <?= Html::cssFile('/static/css/style.css?v=4.0.0'); ?>
    <?= Html::jsFile('/static/js/jquery-2.0.3.min.js'); ?>
</head>
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    ...
                    <span>
                            <img src="<?php echo !empty($user['head_portrait']) ? $user['head_portrait'] : "/static/img/profile_small.jpg" ?>" class="img-circle" width="48" height="48" id="head_portrait">
                    </span>
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li>
                                <a class="J_menuItem" href="<?= Url::to(['manager/personal'])?>"  onclick="$('body').click();">个人中心</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?= Url::to(['manager/up-passwd'])?>"  onclick="$('body').click();">修改密码</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?= Url::to(['cache/clear'])?>"  onclick="$('body').click();">清除缓存</a>
                            </li>
                            <li class="divider"></li>
                ...
                <?= \backend\widgets\menu\MenuLeftWidget::widget() ?>
            </ul>
        </div>
    </nav>
    <!--左侧导航结束-->
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li class="dropdown">
                        <a class="J_menuItem"  href="<?= Url::to(['system/index'])?>">
