...
?>
<link href="/static/other/cropper/cropper.min.css" rel="stylesheet">
<link href="/static/other/cropper/sitelogo.css" rel="stylesheet">
    ...
    <div class="row">
        <div class="col-sm-3">
            <div class="ibox-content text-center">
                <div class="m-b-md">
                    <img class="img-circle circle-border" alt="image" src="<?php echo !empty($model->head_portrait) ? $model->head_portrait : '/static/img/profile_small.jpg' ?>">
                </div>
            ...
            <div class="ibox-content">
                ...
                <p>最后登录IP： <?php echo $model->last_ip ?></p>
                <p>最后登录时间： <?php echo Yii::$app->formatter->asDatetime($model->last_time) ?></p>
            </div>
            <div class="ibox-content">
                <h5>详细地址</h5>
                <p><?= $model->address?></p>
...
<script src="/static/other/cropper/bootstrap.min.js"></script>
<script src="/static/other/cropper/cropper.js"></script>
<script src="/static/other/cropper/sitelogo.js"></script>
<script src="/static/other/cropper/html2canvas.min.js" type="text/javascript" charset="utf-8"></script>
...
<script type="text/javascript">
    ...
    function imagesAjax(src) {
        ...
        data.jid = $('#jid').val();
        $.ajax({
            url     : "<?= Url::to([Yii::$app->params['filesUpload']['base64Url']])?>",
            type    : "post",
            dataType: 'json',
            data    : data,
